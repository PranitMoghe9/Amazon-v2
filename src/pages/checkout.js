...
function Checkout() {
  ...
  const createCheckoutSession = async () => {
    ...
    //call backend to create checkoutsession
  ...
  return (
    <div className="bg-gray-100">
      ...
      <main className="lg:flex max-w-screen-2xl mx-auto">
        {/* left section and middle section*/}
            ...
            <>
              <h2 className="whitespace-nowrap">
                ...
                <span className="font-bold">
                  <Currency quantity={total * 99.96} currency="INR" />
                </span>
              </h2>
              <button
                role="link"
...
//since its a pages (route) so small case and inside can be Caps components
