...
function Header() {
  ...
  const router = useRouter(); //whenever using a hook always create a object
    ...
    <header>
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        <div className="mt-2 flex items-center flex-grow sm:flex-grow-0">
          {/* flex-grow should be till mobile view */}
          <Image
            onClick={() => router.push("/")} //when click on amazon logo then goto home page
        ...
        {/* search */}
        {/* tailwind is mobile first but on small screen hide the search thing but on bigger screens show the searh bar */}
